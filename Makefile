...
LDFLAGS = -X github.com/makeok/go-web-init/pkg/version.gitVersion=$(GIT_VERSION) \
	-X github.com/makeok/go-web-init/pkg/version.gitCommit=$(GIT_COMMIT) \
	-X github.com/makeok/go-web-init/pkg/version.gitBranch=$(GIT_BRANCH) \
	-X github.com/makeok/go-web-init/pkg/version.gitTreeState=$(GIT_STATE) \
	-X github.com/makeok/go-web-init/pkg/version.buildDate=$(BUILD_DATE)
...
build: ## build server
	go build -ldflags "$(LDFLAGS)" -mod vendor -o bin/go-web-init main.go
